...
The below code is an .ino which can be compiled and dumped into esp32
Is intended to take the data from flow sensor and calculate the total amount of liquid/ gas passed through it
